...
namespace WPM {
    ...
    _map.labelsAntialias
            ...
            if (expandCitiesSection) {
                ...
                if (_map.showCities && _map.cities != null) {
                    ...
                    if (_map.enableCityHighlight) {
                        ...
                        _map.citiesHighlightRadius = EditorGUILayout.FloatField("Radius", _map.citiesHighlightRadius);
                        EditorGUI.indentLevel--;
                    }
            ...
            if (expandCameraControlSection) {
                ...
                float prevZoomLevel = Mathf.Clamp(_map.GetZoomLevel(), 1, 2.5f);
                float zoomLevel = EditorGUILayout.Slider("Zoom", prevZoomLevel, 1, 2.5f);
                if (zoomLevel != prevZoomLevel) {
                    _map.SetZoomLevel(zoomLevel);
                }
