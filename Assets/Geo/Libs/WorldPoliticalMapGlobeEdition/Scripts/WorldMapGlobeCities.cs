...
namespace WPM {
    ...
    public partial class WorldMapGlobe : MonoBehaviour {
        ...
        [SerializeField]
        float _citiesHighlightRadius = 0.0025f;

        /// <summary>
        /// Radius that will be colored when a city is highlighted. This only affects the cities icons.
        /// </summary>
        public float citiesHighlightRadius {
            get {
                return _citiesHighlightRadius;
            }
            set {
                if (value != _citiesHighlightRadius) {
                    _citiesHighlightRadius = value;
                    isDirty = true;
                }
            }
        }
