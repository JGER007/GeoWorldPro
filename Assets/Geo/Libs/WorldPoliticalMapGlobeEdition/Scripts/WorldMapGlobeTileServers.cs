    ...
    public partial class WorldMapGlobe : MonoBehaviour {
        ...
        public string GetTileServerCopyrightNotice(TILE_SERVER server) {
            ...
            switch (server) {
                ...
                case TILE_SERVER.GaudeImage:
                    copyright = "高德";
                    break;
                case TILE_SERVER.Satellite:
                    copyright = "卫星影像";
                    break;
                ...
                case TILE_SERVER.City:
                    copyright = "地形";
                    break;
                case TILE_SERVER.NaturalScenery:
                    copyright = "自然风光";
                    break;
        ...
        public string GetTileURL(TILE_SERVER server, TileInfo ti) {
            ...
            switch (_tileServer) {
                ...
                case TILE_SERVER.GoogleMapsSatellite:
                    ...
                    break;
                case TILE_SERVER.GoogleMapsSatelliteNoLabels:
                    url = "http://khm" + (subserverSeq % 4) + ".googleapis.com/kh?v=865&hl=en&z=" + ti.zoomLevel + "&x=" + ti.x + "&y=" + ti.y;
                    break;
                case TILE_SERVER.GoogleMapsRelief:
                ...
                case TILE_SERVER.GaudeImage:
                    ...
                    //高德路网：
                    //url = "https://wprd01.is.autonavi.com/appmaptile?x=" + ti.x + "&y=" + ti.y + "&z=" + ti.zoomLevel + "&lang=zh_cn&size=1&scl=2&style=8&ltype=11";
                    //高德矢量：
                    // url = "http://wprd04.is.autonavi.com/appmaptile?lang=zh_cn&size=1&style=7&x=" + ti.x + "&y=" + ti.y + "&z=" + ti.zoomLevel;

                    //谷歌地形
                    //url = "https://mt1.google.com/vt/lyrs=t&x=" + ti.x + " & y = " + ti.y + " & z = " + ti.zoomLevel;
                    //街景地图：
                    //url = "https://tile.openstreetmap.org/" + ti.zoomLevel + "/" + ti.x + "/" + ti.y  + ".png" ;

                    //天地图影像：
                    //url = "http://t7.tianditu.gov.cn/img_w/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=img&STYLE=default&TILEMATRIXSET=w&FORMAT=tiles&TILEMATRIX=" + ti.zoomLevel + "&TILEROW=" + ti.y + "&TILECOL=" + ti.x + "&tk=4a698f637d68904fdf50e93b2f26925c";
                    url = "http://t0.tianditu.gov.cn/img_w/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=img&STYLE=default&TILEMATRIXSET=w&FORMAT=tiles&TILEMATRIX=" + ti.zoomLevel + "&TILEROW=" + ti.y + "&TILECOL=" + ti.x + "&tk=4a698f637d68904fdf50e93b2f26925c";
                ...
                case TILE_SERVER.Satellite:
                    //url = "http://t7.tianditu.gov.cn/img_w/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=img&STYLE=default&TILEMATRIXSET=w&FORMAT=tiles&TILEMATRIX=" + ti.zoomLevel + "&TILEROW=" + ti.y + "&TILECOL=" + ti.x + "&tk=4a698f637d68904fdf50e93b2f26925c";
                    //url = "https://wprd02.is.autonavi.com/appmaptile?lang=zh_cn&size=1&style=6&x=" + ti.x + "&y=" + ti.y + "&z=" + ti.zoomLevel + "&scl=1&ltype=1";

                    //url = "https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/" + ti.zoomLevel + "/" + ti.y + "/" + ti.x + "";

                    //url = "https://services.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/" + ti.zoomLevel + "/" + ti.y + "/" + ti.x ;
                    url = "https://api.mapbox.com/v4/mapbox.satellite/" + ti.zoomLevel + "/" + ti.x + "/" + ti.y + ".png?access_token=" + _tileServerAPIKey;
                    break;
                ...
                case TILE_SERVER.City:
                    ...
                    //url = "http://wprd03.is.autonavi.com/appmaptile?style=7&x=" + ti.x + "&y=" + ti.y + "&z=" + ti.zoomLevel;
                    break;


                case TILE_SERVER.NaturalScenery:
                    //url = "https://server.arcgisonline.com/arcgis/rest/services/Ocean/World_Ocean_Base/MapServer/tile/" + ti.y + "/" + ti.x + "/" + ti.zoomLevel ;
                    url = "https://a.tiles.mapbox.com/v4/mapbox.satellite/" + ti.zoomLevel + "/24" + ti.x + "/" + ti.y + ".png?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejh2N21nMzAxMmQzMnA5emRyN2lucW0ifQ.jSE-g2vsn48Ry928pqylcg"; 
                    break;
            ...
            /*
            if (_tileServer != TILE_SERVER.GaudeImage && !server.IsMapBox() && !server.IsAerisWeather() && server != TILE_SERVER.Custom && !string.IsNullOrEmpty(_tileServerAPIKey)) {
