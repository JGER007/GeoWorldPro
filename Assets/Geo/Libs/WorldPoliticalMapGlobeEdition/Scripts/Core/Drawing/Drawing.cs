...
namespace WPM {
	public static class Drawing {
		...
		public static TextMeshPro CreateTextPro(string text, GameObject parent, int layer, Vector2 center, TMP_FontAsset labelFont, Material fontMaterial, bool instantiateMaterial, Color textColor, bool addShadow, float shadowOffset, Color shadowColor) {
			...
			if(fontShader == null)
            {
				fontShader = Shader.Find("TextMeshPro/Mobile/Distance Field");
				//fontShader = Shader.Find("TextMeshPro/Distance Field");
			}

			fontMaterial.shader = fontShader ;
			//Debug.Log("name:" + text + ",parent:" + parent + ",instantiateMaterial:" + instantiateMaterial + ",fontMaterial:" + fontMaterial);
