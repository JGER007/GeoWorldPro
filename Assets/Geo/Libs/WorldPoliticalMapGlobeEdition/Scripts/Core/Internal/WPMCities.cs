    ...
    public partial class WorldMapGlobe : MonoBehaviour {
        ...
        void HighlightCity(int cityIndex) {
            ...
            if (_enableCityHighlight) {
                Vector3 pos = city.localPosition;
                UpdateCityMat(citiesNormalMat, pos);
                UpdateCityMat(citiesCountryCapitalMat, pos);
                UpdateCityMat(citiesRegionCapitalMat, pos);
            }
        ...
        void UpdateCityMat(Material mat, Vector3 localPos) {
            mat.SetColor(ShaderParams.CityHighlightColor, _citiesHighlightColor);
            mat.SetVector(ShaderParams.CityHighlightLocalPos, localPos);
            mat.SetFloat(ShaderParams.CityHighlightRadiusSqr, _citiesHighlightRadius * _citiesHighlightRadius);
        }
        ...
        void HideCityHighlight() {
            ...
            UpdateCityMat(citiesNormalMat, Vector4.zero);
            UpdateCityMat(citiesCountryCapitalMat, Vector4.zero);
            UpdateCityMat(citiesRegionCapitalMat, Vector4.zero);
