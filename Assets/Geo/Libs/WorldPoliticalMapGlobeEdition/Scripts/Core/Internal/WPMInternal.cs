...
namespace WPM {
    ...
    public partial class WorldMapGlobe : MonoBehaviour {
        ...
        const float MIN_ZOOM_DISTANCE = 0.0001f;
        // 0.58f;
                ...
                if (isClick || isRelease) {
                    ...
                    if (_provinceLastClicked >= 0) {
                        if (isClick && !fullClick && OnProvincePointerDown != null) {
                            ...
                            if (fullClick && OnProvinceClick != null) //if (fullClick && OnProvinceClick != null) 
                            {
                                if (selectProvincIndex != _provinceLastClicked)
                                {
                                    HideProvinceRegionHighlights(false);
                                    selectProvincIndex = _provinceLastClicked;
                                    HighlightProvinceRegion(selectProvincIndex, _provinceRegionHighlightedIndex,true);
                                }
                                else
                                {
                                    selectProvincIndex = -1;
                                }
        ...
        public int selectProvincIndex = -1;
        public int lastSelectProvincIndex = -1; 
        void CheckMousePos() {
