    ...
    public partial class WorldMapGlobe : MonoBehaviour {
        ...
        void RestyleEarth() {
            ...
            switch (_earthStyle) {
                ...
                case EARTH_STYLE.Nature_No_Cloud:
                    materialName = "Nature_No_Clouds";
                    break;

                case EARTH_STYLE.Nature_Has_Cloud:
                    materialName = "Nature_Has_Clouds";
                    break;

                case EARTH_STYLE.Nature_Night:
                    materialName = "Nature_Night";
                    break;

                default:
                    materialName = "EarthDefault";
                    break;
            }

            //Debug.Log("RestyleEarth _earthStyle:" + _earthStyle + ",materialName:" + materialName);
                ...
                if (skyRenderer != null) {
                    ...
                    if (glowEnabled) {
                        if (_earthGlowScatter) {
                            ...
                            //float ascale = (mainCamera.transform.position.magnitude - 15) /5;
                            skyRenderer.transform.localScale = Misc.Vector3one * 1.01f; //(1.01f + 0.01f*ascale);
