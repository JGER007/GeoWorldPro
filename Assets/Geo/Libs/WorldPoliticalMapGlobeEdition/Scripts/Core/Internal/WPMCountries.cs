...
namespace WPM {
    public partial class WorldMapGlobe : MonoBehaviour {
        ...
        void ReloadFont() {
            ...
            if (_countryLabelsTextEngine == TEXT_ENGINE.TextMeshPro) {
                if (_countryLabelsFontTMPro == null) {
                    _countryLabelsFontTMPro = Resources.Load<TMP_FontAsset>("Font/TextMeshPro/msyhbd SDF");
            ...
            for (int countryIndex = 0; countryIndex < countries.Length; countryIndex++) {
                ...
                if (_countryLabelsTextEngine == TEXT_ENGINE.TextMeshPro) {
                    ...
                    if (country.labelTextMeshPro == null) {
                        ...
                        //Debug.Log("customFont:" + customFont + ",customFontMaterial:" + customFontMaterial + ",customFontMaterial.shader:" + customFontMaterial.shader);
        ...
        {
            if (_countryHighlightedIndex == selectCountryIndex)
            {
                return;
            }
