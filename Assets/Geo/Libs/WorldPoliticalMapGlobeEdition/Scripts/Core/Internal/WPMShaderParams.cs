...
namespace WPM {
    ...
    static class ShaderParams {
        ...
        public static int CityHighlightLocalPos = Shader.PropertyToID("_CityHighlightLocalPos");
        public static int CityHighlightRadiusSqr = Shader.PropertyToID("_CityHighlightRadiusSqr");
        public static int CityHighlightColor = Shader.PropertyToID("_CityHighlightColor");
